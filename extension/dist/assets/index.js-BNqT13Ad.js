import{initContent as Te}from"./content-Bs6sxtKl.js";const te="shopsage-root-v3",ge="shopsage-open-btn-v3",Le="ANALYZE",Me=chrome&&chrome.runtime&&chrome.runtime.getURL?chrome.runtime.getURL("assets/icons/icon.svg"):"/assets/icons/icon.svg";function Y(e){if(e==null)return null;const a=String(e).trim();if(!a)return null;const t=a.match(/([\d.,]+)\s*[Kk]/);if(t){const n=parseFloat(t[1].replace(",","."));if(Number.isFinite(n))return Math.round(n*1e3)}const r=a.replace(/\s+/g,"").replace(/[^0-9\.,]/g,"").replace(",","."),d=parseFloat(r);return Number.isFinite(d)?d:null}function xe(){const e={totalReviews:null,rating:null,totalRatings:null,avgRating:null};try{try{const r=document.querySelector('meta[itemprop="reviewCount"], meta[name="reviewCount"], meta[name="reviews"]');r&&r.content&&(e.totalReviews=Math.round(Y(r.content))||null)}catch{}try{const r=document.querySelector('meta[itemprop="ratingValue"], meta[name="rating"], meta[itemprop="rating"]');r&&r.content&&(e.rating=Math.round(Y(r.content)*100)/100||null)}catch{}const a=['[data-auto="rating-count-text"]',".rating-count",".reviews-count",".votes-count",".ratings-count",".rating__count",".rate__count",".count-ratings",'[data-test="ratings-count"]'];for(const r of a)try{const d=document.querySelector(r);if(d&&(d.innerText||d.textContent)){const n=Y(d.innerText||d.textContent);if(n!=null){e.totalRatings=Math.round(n);break}}}catch{}if(e.totalRatings==null){const r=Array.from(document.querySelectorAll("[aria-label]")||[]);for(const d of r){const x=(d.getAttribute("aria-label")||"").match(/([0-9\s,.Kk]{1,10})\s*(оценок|оценили|оценка|голос|голосов|votes|ratings)/i);if(x){e.totalRatings=Math.round(Y(x[1]));break}}}if(e.totalRatings==null){const d=(document.body.innerText||"").match(/([0-9\s,.Kk]{1,10})\s*(оценок|оценили|оценка|голосов|votes|ratings)/i);d&&(e.totalRatings=Math.round(Y(d[1])))}const t=['[data-auto="rating"]','[data-auto="rating-value"]',".average-rating",".avg-rating",".rating-value",".rating__value",".product-rating",".ds-text_weight_bold"];for(const r of t)try{const d=document.querySelector(r);if(d&&(d.innerText||d.textContent)){const n=Y(d.innerText||d.textContent);if(n!=null){e.avgRating=Math.round(n*100)/100;break}}}catch{}if(e.avgRating==null){const r=Array.from(document.querySelectorAll("[aria-label]")||[]);for(const d of r){const x=(d.getAttribute("aria-label")||"").match(/([0-5](?:[.,][0-9])?)\s*(зв|звезды|рейтинг|rating)/i);if(x){e.avgRating=Y(x[1]);break}}}if(e.avgRating==null){const d=(document.body.innerText||"").match(/(?:средн(?:ий|ая)\s*рейтинг|рейтинг|rating)[:\s]*([0-5](?:[.,][0-9])?)/i);d&&(e.avgRating=Y(d[1]))}try{const r=document.querySelector('[data-zone-name="rating"], [data-auto="ugc-section"]');if(r){const d=r.getAttribute("ratingvalue")||r.getAttribute("data-ratingvalue"),n=r.getAttribute("ratingcount")||r.getAttribute("data-ratingcount")||r.getAttribute("raitingcounttext")||r.getAttribute("data-ratingcounttext"),x=r.getAttribute("reviewcount")||r.getAttribute("data-reviewcount")||r.getAttribute("reviewcounttext")||r.getAttribute("data-reviewcounttext");if(d&&e.avgRating==null&&(e.avgRating=Y(d)),n&&e.totalRatings==null){const m=String(n).match(/([0-9\s,.Kk]+)/);if(m){const f=m[1].replace(/\s+/g,"");e.totalRatings=Math.round(Y(f))}}if(x&&e.totalReviews==null){const m=String(x).match(/([0-9\s,.Kk]+)/);m&&(e.totalReviews=Math.round(Y(m[1])))}}}catch{}try{if(typeof window.extractRatingBreakdown=="function"){const r=window.extractRatingBreakdown();r&&(e.avgRating==null&&r.avg!=null&&(e.avgRating=r.avg),e.totalRatings==null&&r.totalRatings!=null&&(e.totalRatings=r.totalRatings),e.totalReviews==null&&r.totalReviews!=null&&(e.totalReviews=r.totalReviews))}}catch{}}catch(a){console.warn("extractProductMeta error",a)}return e.totalRatings==null&&e.totalReviews!=null&&(e.totalRatings=e.totalReviews),e.avgRating==null&&e.rating!=null&&(e.avgRating=e.rating),e.totalRatings=typeof e.totalRatings=="number"&&Number.isFinite(e.totalRatings)?Math.round(e.totalRatings):null,e.avgRating=typeof e.avgRating=="number"&&Number.isFinite(e.avgRating)?Math.round(e.avgRating*100)/100:null,e.totalReviews=e.totalReviews||null,e.rating=e.rating||null,e}function ae(){const e={5:null,4:null,3:null,2:null,1:null,avg:null,totalRatings:null,totalReviews:null};try{const a=document.querySelector('[data-zone-name="rating"], [data-auto="ugc-section"]');if(a){const x=a.getAttribute("ratingvalue")||a.getAttribute("data-ratingvalue"),m=a.getAttribute("ratingcount")||a.getAttribute("data-ratingcount")||a.getAttribute("raitingcounttext"),f=a.getAttribute("reviewcount")||a.getAttribute("data-reviewcount")||a.getAttribute("reviewcounttext");x&&(e.avg=parseFloat(String(x).replace(",","."))||e.avg),m&&(e.totalRatings=Y(m)||e.totalRatings),f&&(e.totalReviews=Y(f)||e.totalReviews)}const t=document.querySelector('[data-auto="rating-count-text"], [data-auto="ratingCount"], .rating-count, .ds-text[data-auto="rating-count-text"]'),r=document.querySelector('[data-auto="review-count-text"], .review-count, .ds-text[data-auto="review-count-text"]');t&&!e.totalRatings&&(e.totalRatings=Y(t.innerText||t.textContent)||e.totalRatings),r&&!e.totalReviews&&(e.totalReviews=Y(r.innerText||r.textContent)||e.totalReviews);const d=[".rating-breakdown",".rating-histogram",".rating-list",".rating-distribution",'[data-auto="rating-breakdown"]',".review-stats",".rating-row",".ratingRow",".ds-rating-list"];for(const x of d){const m=document.querySelector(x);if(!m)continue;const f=Array.from(m.querySelectorAll("*"));let b=0;for(const q of f){const S=(q.textContent||"").trim(),L=S.match(/^\s*([1-5])\D{0,6}([0-9\s,.Kk]{1,12})\s*$/);if(L){const A=Number(L[1]),R=Y(L[2]);A>=1&&A<=5&&R!=null&&(e[A]=R,b++)}else{const A=S.match(/^\s*([1-5])\s*$/);if(A){const R=Number(A[1]);let w=null;const i=q.nextElementSibling||q.parentElement&&q.parentElement.querySelector(".count, .value, .number, .ds-text");i&&(w=Y(i.textContent||i.innerText)),w!=null&&(e[R]=w,b++)}}}if(b>0)break}const n=Array.from(document.querySelectorAll('noframes[data-apiary="patch"]')||[]);for(const x of n){const m=(x.textContent||"").trim();if(m)try{const f=JSON.parse(m);if(f.collections&&f.collections.businessReviewStats){const A=Object.keys(f.collections.businessReviewStats);if(A.length){const R=f.collections.businessReviewStats[A[0]];if(R&&(R.reviewsCount&&!e.totalReviews&&(e.totalReviews=Number(R.reviewsCount)||e.totalReviews),R.reviewsCountVisualization&&!e.totalRatings)){const w=String(R.reviewsCountVisualization).match(/([\d.,]+)K/i);w&&(e.totalRatings=Math.round(parseFloat(w[1].replace(",","."))*1e3))}}}const b=m,q=b.match(/"ratingvalue"\s*:\s*"?([0-9.,]+)"?/i),S=b.match(/"ratingcount"\s*:\s*(\d+)/i),L=b.match(/"reviewcount"\s*:\s*(\d+)/i);q&&(e.avg=parseFloat(q[1].replace(",","."))||e.avg),S&&(e.totalRatings=Number(S[1])||e.totalRatings),L&&(e.totalReviews=Number(L[1])||e.totalReviews)}catch{}}}catch{}return["5","4","3","2","1"].forEach(a=>{e[a]==null&&(e[a]=null)}),e.avg!=null&&(e.avg=Math.round(Number(e.avg)*100)/100),e.totalRatings!=null&&(e.totalRatings=Math.round(Number(e.totalRatings))),e.totalReviews!=null&&(e.totalReviews=Math.round(Number(e.totalReviews))),e}function Ie(e=15e3){const a={reviews:[],totalFound:0,charactersUsed:0,extractionMethods:[]};try{let t=function(){const i=['[data-auto="reviews-show-more"]','[data-autotest-id*="show-more"]',".reviews-show-more",".show-more",".load-more","button"],o=new Set;for(const u of i)try{Array.from(document.querySelectorAll(u)).forEach(s=>{try{if(!(s instanceof HTMLElement))return;const c=window.getComputedStyle(s);if(c.display==="none"||c.visibility==="hidden"||s.disabled)return;const k=(s.innerText||s.textContent||"").trim();(/показать|еще|ещё|загрузить|more|show/i.test(k)||u.indexOf("show-more")>=0||u.indexOf("reviews-show-more")>=0)&&!o.has(s)&&(s.click(),o.add(s),setTimeout(()=>{try{s.disabled||s.click()}catch{}},900))}catch{}})}catch{}try{const u=document.querySelector('[data-zone-name="reviews"], [data-auto="ugc-section"], .reviews, .n-reviews, .review-list, [data-auto="reviews"]');if(u)try{u.scrollIntoView({behavior:"smooth"}),u.scrollTop=u.scrollHeight}catch{}else window.scrollTo({top:document.body.scrollHeight,behavior:"smooth"})}catch{}},r=function(){const i=['button[class*="expand"]','button[class*="show-full"]','[data-auto*="expand"]',".review-expand",".opinion-expand",'button:contains("Развернуть")','button:contains("Показать полностью")','button:contains("Читать полностью")','[class*="read-more"]'];for(const o of i)try{document.querySelectorAll(o).forEach(h=>{try{h.offsetHeight>0&&h.click()}catch{}})}catch{}},d=function(){const i=[];try{document.querySelectorAll("script").forEach(h=>{if(!h.textContent)return;[/"reviews":\s*\[(.*?)\]/gs,/"opinions":\s*\[(.*?)\]/gs,/"reviewText":\s*"([^"]+)"/g,/"text":\s*"([^"]+)"/g,/"comment":\s*"([^"]+)"/g].forEach(c=>{const k=h.textContent.matchAll(c);for(const y of k)try{if(y[1]&&y[1].length>30){const g=y[1].replace(/\\n/g," ").replace(/\\"/g,'"').replace(/\\\\/g,"\\").trim();g.length>30&&i.push(g)}}catch{}})}),document.querySelectorAll("[data-bem]").forEach(h=>{try{Object.values(h.dataset).forEach(s=>{if(!(!s||s.length<100))try{const c=JSON.parse(s),k=c.reviews||c.opinions;Array.isArray(k)&&k.forEach(y=>{const g=y.text||y.content||y.comment;g&&g.length>30&&i.push(String(g))})}catch{}})}catch{}})}catch{}return i},n=function(i){if(!i)return"";let o=String(i).replace(/\r\n|\r/g,`
`).replace(/\t/g," ").replace(/\u00A0/g," ");o=o.replace(/\s+/g," ").trim(),o=o.replace(/\b(?:\d+\s+){3,}\d+\b/g," "),o=o.replace(/\b\d{3,}\b/g," "),o=o.replace(/(?:\b\d+\b[\s,.-]*){3,}/g," ");try{o=o.replace(/[^\p{L}\p{N}\s\.,!?\-()«»—:;\/%]/gu," ")}catch{o=o.replace(/[^A-Za-zА-Яа-яЁё0-9\s\.,!?\-()«»—:;\/%]/g," ")}return o=o.replace(/([,!.?–—\-]){2,}/g,"$1"),o=o.replace(/\s+/g," ").trim(),o},x=function(i){if(!i)return"";const o=[".review-text",".opinion-text",".review-content",".comment-text",'[data-auto="review-text"]','[class*="text"]',"p",".content"];try{for(const s of o){const c=i.querySelector?i.querySelector(s):null;if(c&&c.innerText&&c.innerText.trim().length>20)return n(c.innerText)}}catch{}let u="";try{u=i.innerText||i.textContent||""}catch{u=""}return[/Достоинства:?\s*/gi,/Недостатки:?\s*/gi,/Комментарий:?\s*/gi,/Опыт использования:?\s*/gi,/Рекомендую\s*/gi,/Не рекомендую\s*/gi,/\d+\s*из\s*\d+\s*считают отзыв полезным/gi,/Был ли отзыв полезен\?/gi,/Да\s*\d*\s*Нет\s*\d*/gi,/\d+\s*звезд[ыа]?/gi,/Оценка:\s*\d+/gi].forEach(s=>{u=u.replace(s," ")}),n(u)},m=function(i){if(!i)return!1;const o=i.length;return!(o<40||(i.match(/\d/g)||[]).length/Math.max(1,o)>.3||(i.match(/[A-Za-zА-Яа-яЁё]/g)||[]).length<12||(i.match(/[А-Яа-яЁё]/g)||[]).length<Math.min(10,Math.floor(o*.2))||/^(source|businessId|notEmpty|id|source,)/i.test(i.trim()))},f=function(i){const o=new Set,u=[];return i.forEach(h=>{const s=h.text.toLowerCase().replace(/\s+/g,"").substring(0,100);o.has(s)||(o.add(s),u.push(h))}),u},b=function(i,o){const u=[];let h=0;const c=`

`.length,k=i.sort((y,g)=>g.length-y.length);for(const y of k){const g=y.length,F=h===0?g:g+c;if(h+F<=o)u.push(y),h+=F;else if(h===0){const D=y.substring(0,o-3)+"...";u.push(D),h=D.length;break}else{const D=o-h-c;if(D>50){const H=y.substring(0,D-3)+"...";u.push(H);break}else break}}return u};t(),r();const q=['[data-auto="review-item"]','[data-zone-name="review"]','[data-autotest-id="review-card"]','[data-tid="review-item"]','[data-auto="OpinionCard"]',".opinion",".review-item",".user-review",'[class*="review"]','[class*="opinion"]','[data-zone*="review"]',".n-review-card",".ProductReview",'iframe[src*="review"] + *','[data-bem*="review"]'],S=new Set;for(const i of q)try{const o=document.querySelectorAll(i);o.forEach(u=>{try{u&&u.innerText&&u.innerText.trim().length>20&&S.add(u)}catch{}}),o.length>0&&a.extractionMethods.push(`${i}: ${o.length} элементов`)}catch{}const L=d(),A=[];S.forEach(i=>{try{const o=x(i),u=n(o);m(u)&&A.push({text:u,source:"dom",length:u.length,element:i})}catch{}}),L.forEach(i=>{try{const o=n(i);m(o)&&A.push({text:o,source:"json",length:o.length})}catch{}});const R=f(A);R.sort((i,o)=>o.length-i.length);const w=b(R.map(i=>i.text),e);return a.reviews=w,a.totalFound=R.length,a.charactersUsed=w.reduce((i,o)=>i+(o?o.length:0),0),a}catch(t){return console.warn("extractYandexMarketReviews error",t),a}}function Ne(e){if(!e)return"";let a=String(e);return a=a.replace(/[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}/gi,"[email]"),a=a.replace(/(\+?\d[\d\-\s()]{6,}\d)/g,"[phone]"),a=a.replace(/https?:\/\/\S+/gi,"[url]"),a=a.replace(/\b\d{6,}\b/g,"[id]"),a.length>2e3&&(a=a.slice(0,2e3)+"…"),a.trim()}async function $e(e=20){let a=[];try{typeof ie=="function"&&(a=ie(),Array.isArray(a)||(a=[]))}catch(n){console.error("Ошибка при извлечении отзывов:",n),a=[]}const t=a.slice(0,e).map((n,x)=>{const m=typeof n=="string"?n:n.text||"";return{id:x+1,text:Ne(m),length:m.length}});let r={};try{typeof extractProductMeta=="function"&&(r=extractProductMeta()||{})}catch(n){console.error("Ошибка при извлечении мета данных продукта:",n),r={}}const d=await chrome.storage.sync.get({serverUrl:""});return{version:"1.0",source:location.hostname,serverUrlPreview:d.serverUrl||"",product:{url:location.href,title:document.title,avgRating:r.avgRating??null,totalRatings:r.totalRatings??null},reviewsCount:t.length,reviewsSample:t}}function he(e,{maxLength:a=2e3}={}){if(e==null)return"";let t=String(e);return t=t.replace(/^\s*\S+\s+\S+\s*/,"[имя удалено]"),t=t.replace(/\u00A0/g," ").replace(/\s+/g," ").trim(),t=t.replace(/\[телефон (удалён|удалено)\]/gi,"[телефон удалён]"),t=t.replace(/\[email (удалён|удалено)\]/gi,"[email удалён]"),t=t.replace(/\[url (удалён|удалено)\]/gi,"[url удалён]"),t=t.replace(/\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}\b/gi,"[email удалён]"),t=t.replace(/\b([A-Za-z0-9._%+-]+)\s*(?:\[at\]|\(at\)|\sat\s|&#x40;)\s*([A-Za-z0-9.-]+\.[A-Za-z]{2,})\b/gi,"[email удалён]"),t=t.replace(/https?:\/\/[^\s"']+/gi,"[url удалён]"),t=t.replace(/\bwww\.[^\s"']+\b/gi,"[url удалён]"),t=t.replace(/\b(?:t\.me|telegram\.me|telegram|vk\.com|vk)\b[\/:]?[A-Za-z0-9_.-]*/gi,"[url удалён]"),t=t.replace(/@[A-Za-z0-9_.-]{1,80}/g,"[ник удалён]"),t=t.replace(/\b[A-Za-z0-9._-]{3,}#\d{2,6}\b/g,"[ник удалён]"),t=t.replace(/(?:(?:\+?\d{1,3}[-.\s\/]?)?(?:\(?\d{1,4}\)?[-.\s\/]?){1,6}\d{1,4})(?=(?:\D|$))/g,r=>(r.match(/\d/g)||[]).length>=6?"[телефон удалён]":r),t=t.replace(/\b\d{6,}\b/g,"[id удалён]"),t=t.replace(/\bИмя\s+скрыто\b/gi,"[имя удалено]"),t=t.replace(/\bИмя\s+удалено\b/gi,"[имя удалено]"),t=t.replace(/\bПользователь\b/gi,"[пользователь]"),t=t.replace(/\bПокупатель\b/gi,"[пользователь]"),t=t.replace(/\bАноним\b/gi,"[пользователь]"),t=t.replace(/\bGuest\b/gi,"[пользователь]"),t=t.replace(/\b[А-ЯЁA-Z][а-яёa-zA-Z-]{1,30}\s+[А-ЯЁA-Z][а-яёa-zA-Z-]{1,30}(?:\s+[А-ЯЁA-Z][а-яёa-zA-Z-]{1,30})?\b/gu,"[имя удалено]"),t=t.replace(/\b[А-ЯЁA-Z][а-яёa-zA-Z-]{1,30}\s+[A-ЯA-ZА-ЯЁ]\.(?:\s*[A-ЯA-Z]\.)?\b/gu,"[имя удалено]"),t=t.replace(/\b[А-ЯЁA-Z][а-яёa-zA-Z-]{1,30}\s+[A-ЯA-ZА-ЯЁ]\b/gu,"[имя удалено]"),t=t.replace(/\b[A-ЯA-ZА-ЯЁ]\.\s*[А-ЯЁA-Z][а-яёa-zA-Z-]{1,30}\b/gu,"[имя удалено]"),t=t.replace(/^(?:\s*)([А-ЯЁA-Z][а-яёa-zA-Z-]{2,30})(?=\s+(?:\d{1,2}\s+|[A-Za-zА-Яа-я]))/u,"[имя удалено]"),t=t.replace(/\b[А-ЯЁA-Z][а-яёa-zA-Z-]{2,30}\s+[A-ЯЁA-Z][а-яёa-zA-Z-]{0,30}(?=\s+\d{1,2}\s+(?:янв|фев|мар|апр|май|июн|июл|авг|сен|окт|ноя|дек|января|февраля|марта|апреля|мая|июня|июля|августа|сентября|октября|ноября|декабря))/giu,"[имя удалено]"),t=t.replace(/\s+/g," ").trim(),t.length>a&&(t=t.slice(0,a-1)+"…"),t}const ke="verdict:userSettings",_={autoAnalyze:!1,serverSend:!1,maxReviews:5,language:"ru",analysisDepth:"medium",showRating:!0,debugMode:!1,saveHistory:!1,darkMode:!0};async function se(e={}){try{const a={...e};return localStorage.setItem(ke,JSON.stringify(a)),!0}catch(a){return console.error("saveUserSettings error:",a),!1}}function oe(){try{const e=localStorage.getItem(ke);return e?JSON.parse(e)||{}:{}}catch(e){return console.warn("Ошибка чтения настроек из localStorage:",e),{}}}async function ye(){try{if(console.debug("[utils] isUserSubscribed: probing environment"),typeof window.isUserSubscribed=="function"){const e=window.isUserSubscribed();return e&&typeof e.then=="function"?!!await e:!!e}if(window.APP&&window.APP.user&&typeof window.APP.user.isSubscribed<"u")return!!window.APP.user.isSubscribed;try{const e=localStorage.getItem("IS_SUBSCRIBED")||localStorage.getItem("user_subscribed");if(e==="1"||e==="true")return!0}catch{}return!1}catch(e){return console.warn("[utils] isUserSubscribed error",e),!1}}function Be(){const a=(oe()||{}).maxReviews,t=Number(a);if(Number.isFinite(t)&&!Number.isNaN(t)){const r=Math.trunc(t);return r>=0?r:_.maxReviews}return _.maxReviews}function ie(e=10){if(e=Be(),window.location.hostname.includes("market.yandex")||document.title.includes("Яндекс.Маркет")||document.querySelector('[data-baobab-name*="market"]')){const n=Ie(15e3);return(n&&n.reviews?n.reviews:[]).map(m=>{const f=typeof m=="string"?m:m&&(m.text||m.review||"")||"";return{raw:f,anon:he(String(f))}}).filter(m=>m.raw&&m.raw.length>30).map(m=>m.anon).slice(0,e)}const t=['[data-zone-name="review"]','[data-autotest-id="review-card"]',".review__item",".product-review",".review",".comments-item",'[data-test-id*="review"]',".feedback",".pa-review",".review-item",".reviewCard"];let r=[];for(const n of t){const x=document.querySelectorAll(n);if(x&&x.length){r=Array.from(x);break}}const d=r.map(n=>{const m=(n?.textContent||n?.innerText||"").trim();return m?he(m):""}).filter(n=>n&&n.length>30).slice(0,e);return console.debug("ShopSage: Standard extraction found",d.length,"reviews"),d}function we(e){return e==null?"—":`${Math.round(e*10)/10} <svg class="star" width="14" height="14" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M12 .587l3.668 7.431 8.2 1.192-5.934 5.787 1.402 8.167L12 18.896l-7.336 3.868 1.402-8.167L.132 9.21l8.2-1.192z"/></svg>`}function Oe(e,a={}){const t=e.getElementById?e.getElementById("ss-preview-modal"):e.querySelector("#ss-preview-modal");if(t)try{t.style.animation="modalSlideOut 200ms cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards",setTimeout(()=>t.remove(),200)}catch{t.remove()}const r=document.createElement("div");r.id="ss-preview-modal";const d=a.product?.title||document.title||"Неизвестный товар",n=a.product?.url||location.href,x=JSON.stringify(a,null,2),m=new Blob([x]).size,f=a._truncated===!0;function b(s){return String(s).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function q(s){try{const c=new URL(s),k=c.pathname.length>24?c.pathname.slice(0,21)+"…":c.pathname;return`${c.hostname}${k}`}catch{return s.length>40?s.slice(0,37)+"…":s}}function S(s){return!s||s<1024?`${s} Б`:s<1024*1024?`${Math.round(s/1024)} КБ`:`${(s/(1024*1024)).toFixed(2)} МБ`}function L(s,c=45){return s.length>c?s.slice(0,c)+"…":s}r.innerHTML=`
        <div class="pm-header">
            <div>
            ...
            <div class="pm-summary">
                ...
                <div class="pm-summary-row">
                    <div style="flex: 1;">
                        ...
                        <div class="pm-value">
                            <a href="${b(n)}" class="pm-link" target="_blank" rel="noopener noreferrer"
                               title="${b(n)}">${b(q(n))}</a>
                        </div>
                    </div>
                </div>
    ...
    `,e.appendChild(r);const A=r.querySelector(".pm-close"),R=r.querySelector(".btn-close-action"),w=r.querySelector(".btn-copy"),i=r.querySelector(".btn-download"),o=r.querySelector(".pm-link");function u(){try{r.style.animation="modalSlideOut 200ms cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards",setTimeout(()=>{try{r.remove()}catch{}},200)}catch{try{r.remove()}catch{}}document.removeEventListener("keydown",h)}A?.addEventListener("click",u),R?.addEventListener("click",u),w?.addEventListener("click",async()=>{const s=w.querySelector(".btn-text")?.textContent||"Копировать",c=w.querySelector(".btn-text");try{await navigator.clipboard.writeText(x),w.classList.add("btn-success"),c&&(c.textContent="Скопировано!"),setTimeout(()=>{w.classList.remove("btn-success"),c&&(c.textContent=s)},1500)}catch{w.classList.add("btn-error"),c&&(c.textContent="Ошибка!"),setTimeout(()=>{w.classList.remove("btn-error"),c&&(c.textContent=s)},1500);try{const y=r.querySelector("pre");if(y){const g=document.createRange();g.selectNodeContents(y);const F=window.getSelection();F.removeAllRanges(),F.addRange(g)}}catch{}}}),i?.addEventListener("click",()=>{const s=i.querySelector(".btn-text")?.textContent||"Скачать",c=i.querySelector(".btn-text");try{const k=new Blob([x],{type:"application/json;charset=utf-8"}),y=URL.createObjectURL(k),g=document.createElement("a");g.href=y,g.download=`shopsage-data-${new Date().toISOString().slice(0,19).replace(/[:.]/g,"-")}.json`,document.body.appendChild(g),g.click(),g.remove(),URL.revokeObjectURL(y),i.classList.add("btn-success"),c&&(c.textContent="Скачано!"),setTimeout(()=>{i.classList.remove("btn-success"),c&&(c.textContent=s)},1500)}catch(k){i.classList.add("btn-error"),c&&(c.textContent="Ошибка!"),setTimeout(()=>{i.classList.remove("btn-error"),c&&(c.textContent=s)},1500),console.error("Download failed:",k)}}),o?.addEventListener("click",s=>{s.preventDefault();try{window.open(n,"_blank","noopener,noreferrer")}catch(c){console.warn("Could not open product URL:",c)}});function h(s){s.key==="Escape"&&u()}return document.addEventListener("keydown",h),r.addEventListener("click",s=>{s.target===r&&u()}),r}function _e(e,a={}){const t=typeof oe=="function"?oe():window.__loadedSettings||{},r={..._,...t,...a},d=e.getElementById?e.getElementById("ss-settings-modal"):e.querySelector("#ss-settings-modal");if(d)try{d.style.animation="modalSlideOut 200ms cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards",setTimeout(()=>d.remove(),200)}catch{d.remove()}const n=document.createElement("div");n.id="ss-settings-modal";const x=r.maxReviews??_.maxReviews??5;n.innerHTML=`
      <div class="sm-header">
        <div>
    ...
    `,e.appendChild(n);const m=n.querySelector(".sm-close"),f=n.querySelector(".btn-close-action"),b=n.querySelector(".btn-save"),q=n.querySelector(".btn-reset"),S=n.querySelector("#set-max-reviews"),L=n.querySelector("#max-reviews-value"),A=n.querySelector("#max-range-lock"),R=n.querySelector("#set-auto-analyze"),w=n.querySelector("#set-save-history"),i=n.querySelector('input[name="analysis-depth"][value="deep"]'),o=n.querySelector('input[name="analysis-depth"][value="medium"]'),u=Array.from(n.querySelectorAll(".feature-lock"));function h(){return typeof Se=="function"?Se:window.__utils&&typeof window.__utils.showSubscriptionModal=="function"?window.__utils.showSubscriptionModal:(p={},l)=>{const v=new CustomEvent("subscriptionRequest",{detail:{reason:"unlock-max-reviews"},bubbles:!0,composed:!0});return document.dispatchEvent(v),()=>{}}}let s=null;function c(){if(s)return;const p=h(),l=n||e||document.body;try{const v=p({message:"Доступ к расширенным функциям доступен только по подписке. Оформить подписку?",onBuy:()=>{const N=new CustomEvent("subscriptionRequest",{detail:{reason:"unlock-max-reviews"},bubbles:!0,composed:!0});document.dispatchEvent(N)}},l),M=l instanceof ShadowRoot||l instanceof Element?l.querySelector("#subscription-modal-overlay"):document.getElementById("subscription-modal-overlay");if(typeof v=="function"){let N=null;if(M){const P=l instanceof ShadowRoot||l instanceof Element?l:document.body;N=new MutationObserver(()=>{if(!M.isConnected){s=null;try{N.disconnect()}catch{}}}),N.observe(P,{childList:!0,subtree:!0})}s=()=>{try{v()}catch{}s=null;try{N&&N.disconnect()}catch{}}}else if(M){const N=l instanceof ShadowRoot||l instanceof Element?l:document.body,P=new MutationObserver(()=>{M.isConnected||(s=null,P.disconnect())});P.observe(N,{childList:!0,subtree:!0}),s=()=>{try{M.remove()}catch{}s=null;try{P.disconnect()}catch{}}}else s=null}catch{const M=new CustomEvent("subscriptionRequest",{detail:{reason:"unlock-max-reviews"},bubbles:!0,composed:!0});document.dispatchEvent(M),s=null}}let k=!!r.isSubscribed;function y(p){k=!!p,k&&A?(A.style.display="none",A.setAttribute("aria-hidden","true")):A&&(A.style.display="block",A.setAttribute("aria-hidden","false")),u.forEach(l=>{l.getAttribute("data-feature"),k?(l.style.display="none",l.setAttribute("aria-hidden","true")):(l.style.display="block",l.setAttribute("aria-hidden","false"))}),k?(i&&(i.disabled=!1),R&&(R.disabled=!1),w&&(w.disabled=!1)):(i&&(i.checked&&o&&(i.checked=!1,o.checked=!0),i.disabled=!0),R&&(R.checked=!1,R.disabled=!0),w&&(w.checked=!1,w.disabled=!0))}if(typeof ye=="function")try{const p=ye();p&&typeof p.then=="function"?p.then(l=>y(!!l)).catch(()=>y(!!r.isSubscribed)):y(!!p)}catch{y(!!r.isSubscribed)}else y(!!r.isSubscribed);L&&(L.textContent=String(S?.value??x)),u.forEach(p=>{p.addEventListener("click",l=>{l.stopPropagation(),c()})}),n.querySelector('.setting-option .feature-row label[for="set-auto-analyze"]');const g=R?R.closest("label"):null;g&&g.addEventListener("click",p=>{k||(p.preventDefault(),c())});const F=w?w.closest("label"):null;F&&F.addEventListener("click",p=>{k||(p.preventDefault(),c())});const D=i?i.closest("label"):null;D&&D.addEventListener("click",p=>{k||(p.preventDefault(),setTimeout(()=>{i&&(i.checked=!1),o&&(o.checked=!0)},0),c())}),S?.addEventListener("input",p=>{let l=parseInt(p.currentTarget?.value,10)||x;!k&&l>10&&(c(),l=10,S.value="10"),L&&(L.textContent=String(l))}),A?.addEventListener("click",p=>{p.stopPropagation(),!k&&c()});function H(){try{n.style.animation="modalSlideOut 200ms cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards",setTimeout(()=>{try{n.remove()}catch{}},200)}catch{try{n.remove()}catch{}}document.removeEventListener("keydown",V);try{typeof s=="function"&&s()}catch{}s=null}function ce(){const p=parseInt(n.querySelector("#set-max-reviews")?.value,10)||_.maxReviews,l=!k&&p>10?10:p;return{autoAnalyze:!!n.querySelector("#set-auto-analyze")?.checked,serverSend:!!n.querySelector("#set-server-send")?.checked,maxReviews:l,maxReviews:l,language:n.querySelector("#set-language")?.value||"ru",analysisDepth:n.querySelector('input[name="analysis-depth"]:checked')?.value||"medium",showRating:!!n.querySelector("#set-show-rating")?.checked,debugMode:!!n.querySelector("#set-debug-mode")?.checked,saveHistory:!!n.querySelector("#set-save-history")?.checked}}function de(){n.querySelector("#set-auto-analyze").checked=_.autoAnalyze,n.querySelector("#set-server-send").checked=_.serverSend,n.querySelector("#set-max-reviews").value=_.maxReviews;const p=n.querySelector("#max-reviews-value");p&&(p.textContent=String(_.maxReviews)),n.querySelector("#set-language").value=_.language;const l=n.querySelector(`input[name="analysis-depth"][value="${_.analysisDepth}"]`);l&&(l.checked=!0),n.querySelector("#set-show-rating").checked=_.showRating,n.querySelector("#set-debug-mode").checked=_.debugMode,n.querySelector("#set-save-history").checked=_.saveHistory,!k&&parseInt(n.querySelector("#set-max-reviews").value,10)>10&&(n.querySelector("#set-max-reviews").value="10",p&&(p.textContent="10")),k||(i&&i.checked&&o&&(i.checked=!1,o.checked=!0),R&&(R.checked=!1,R.disabled=!0),w&&(w.checked=!1,w.disabled=!0))}q?.addEventListener("click",async()=>{try{localStorage.removeItem(SETTINGS_KEY),typeof se=="function"&&await se({..._||{},maxReviews:_.maxReviews??5,maxReviews:_.maxReviews??5})}catch(v){console.warn("Не удалось удалить/сохранить ключ настроек:",v)}de();const p=q.querySelector(".btn-text")?.textContent||"Сбросить",l=q.querySelector(".btn-text");l&&(l.textContent="Сброшено!"),setTimeout(()=>{l&&(l.textContent=p)},1e3)}),m?.addEventListener("click",H),f?.addEventListener("click",H),b?.addEventListener("click",async()=>{const p=ce();try{typeof se=="function"?await se(p):localStorage.setItem(SETTINGS_KEY,JSON.stringify(p))}catch(N){console.error("Ошибка при сохранении настроек:",N)}const l=new CustomEvent("settingsChanged",{detail:p,bubbles:!0,composed:!0});try{e.dispatchEvent(l)}catch{n.dispatchEvent(l)}const v=b.querySelector(".btn-text")?.textContent||"Сохранить",M=b.querySelector(".btn-text");b.classList.add("btn-success"),M&&(M.textContent="Сохранено!"),setTimeout(()=>{b.classList.remove("btn-success"),M&&(M.textContent=v),H()},1200)});function V(p){p.key==="Escape"&&H()}return document.addEventListener("keydown",V),setTimeout(()=>{n.addEventListener("click",p=>{p.target===n&&H()})},100),n}function Se(e={},a=document.body){const{title:t="Разблокировать расширенный анализ",message:r="Больше 10 отзывов доступно только по подписке. Хотите оформить подписку?",buyText:d="Купить подписку",cancelText:n="Нет",onBuy:x}=e,m="subscription-modal-overlay";let f=document.body,b=!1;a&&(a instanceof ShadowRoot||a instanceof Element?(f=a,b=!0):(f=document.body,b=!1));try{const g=b?f.querySelector(`#${m}`):document.getElementById(m);if(g)return()=>{try{g.remove()}catch{}}}catch{}function q(g){return String(g).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}const S=document.createElement("div");S.id=m,S.className="subscription-modal-overlay";const L=document.createElement("style");L.textContent=`
  ...
  `,S.appendChild(L),S.innerHTML+=`
    <div class="subscription-modal" role="dialog" aria-modal="true" aria-labelledby="subscription-modal-title">
      ...
      <div class="subscription-content">
        <h3 id="subscription-modal-title">${q(t)}</h3>
        <p class="subscription-message">${q(r)}</p>
        <div class="subscription-actions">
          <button class="subscription-buy">${q(d)}</button>
          <button class="subscription-cancel">${q(n)}</button>
        </div>
      </div>
    </div>
  `;let A=null;if(b&&f instanceof Element){const g=window.getComputedStyle(f);(!g.position||g.position==="static")&&(A=f.style.position||"",f.style.position="relative")}b?f.appendChild(S):document.body.appendChild(S);const R=document.body.style.overflow;b||(document.body.style.overflow="hidden");const w=S.querySelector(".subscription-buy"),i=S.querySelector(".subscription-cancel"),o=S.querySelector(".subscription-close");let u=!1;function h(){if(!u){u=!0;try{S.remove()}catch{}if(A!==null&&f instanceof Element)try{f.style.position=A}catch{}b||(document.body.style.overflow=R||""),document.removeEventListener("keydown",y)}}function s(g){g.stopPropagation();try{typeof x=="function"?x():document.dispatchEvent(new CustomEvent("subscriptionRequest",{detail:{reason:"unlock-max-reviews"},bubbles:!0,composed:!0}))}catch{}h()}function c(g){g.stopPropagation(),h()}function k(g){g.target===S&&h()}function y(g){g.key==="Escape"&&h()}return w?.addEventListener("click",s),i?.addEventListener("click",c),o?.addEventListener("click",c),S.addEventListener("click",k),document.addEventListener("keydown",y),h}const Ye=`<aside\r
...
`;function K(){if(document.getElementById(te)){const v=document.getElementById(te)._hostElement;if(!v)return;v.style.opacity==="1"?le():(v.style.opacity="1",v.style.transform="translateY(0) scale(1)");return}const e=document.createElement("div");e.id=te,Object.assign(e.style,{all:"initial",position:"fixed",right:"20px",top:"60px",zIndex:"2147483647",pointerEvents:"auto"});const a=e.attachShadow({mode:"open"});e._hostElement=e;const t=document.createElement("style");t.textContent=Ue,a.appendChild(t);const r=document.createElement("div");r.innerHTML=Ye,a.appendChild(r);const d=a.querySelector("#ss-logo");d&&(d.src=chrome.runtime.getURL("assets/icons/icon.svg")),document.body.appendChild(e);const n=a,x=n.querySelector(".shopsage-sidebar"),m=n.querySelector(".ss-close"),f=n.querySelector("#ss-analyze"),b=n.querySelector("#ss-loader"),q=n.querySelector("#ss-count"),S=n.querySelector("#ss-result"),L=n.querySelector("#ss-pros"),A=n.querySelector("#ss-cons"),R=n.querySelector("#ss-verdict"),w=n.querySelector("#ss-rating"),i=n.querySelector("#ss-total"),o=n.querySelector("#ss-error"),u=n.querySelector("#ss-score-container"),h=n.querySelector("#ss-score-badge"),s=n.querySelector("#ss-score-bar-inner"),c=n.querySelector("#ss-score-sub"),k=n.querySelector("#ss-send-server"),y=n.querySelector("#ss-preview-payload"),g=n.querySelector("#ss-preview-settings");k&&k.addEventListener("change",l=>{const v=!!l.target.checked;chrome.storage.sync.set({sendToServer:v})}),y&&y.addEventListener("click",async()=>{try{y.disabled=!0;const l=await $e();Oe(n,l)}catch(l){console.error("preview error",l),alert("Ошибка при формировании превью: "+String(l))}finally{y.disabled=!1}}),g&&g.addEventListener("click",async()=>{try{g.disabled=!0;const l=await oe();_e(n,l)}catch(l){console.error("preview error",l),alert("Ошибка при формировании превью: "+String(l))}finally{g.disabled=!1}}),requestAnimationFrame(()=>{Object.assign(e.style,{opacity:"0",transform:"translateY(8px) scale(.995)",transition:"opacity .28s cubic-bezier(.2,.9,.2,1), transform .36s cubic-bezier(.2,.9,.2,1)"}),setTimeout(()=>{e.style.opacity="1",e.style.transform="translateY(0) scale(1)"},20)}),m&&m.addEventListener("click",le),f&&f.addEventListener("click",ce);const F=ie();q&&(q.innerText=F.length);const D=xe();w&&(w.innerHTML=we(D.avgRating)),i&&(i.innerText=D.totalRatings!=null?D.totalRatings:"—");function H(l){o&&(o.innerText=l,p(o),setTimeout(()=>{V(o)},5e3))}function ce(l){f&&(f.disabled=!0),b&&p(b),S&&V(S),u&&V(u),c&&V(c),o&&V(o);const v=15e3,M=`

`;chrome.storage.sync.get({maxReviews:20,serverUrl:""},N=>{const P=Number.isFinite(Number(N.maxReviews))&&Number(N.maxReviews)>0?Number(N.maxReviews):20,j=ie(P);let B=[],U=0;if(Array.isArray(j)?(B=j,U=j.length):j&&typeof j=="object"?(B=j.items||[],U=Number.isFinite(Number(j.found))?j.found:B.length||0):(B=[],U=0),U<P&&console.info(`Verdict: Requested ${P} reviews but only ${U} found on page. Using available reviews.`),!B||B.length===0){b&&V(b),f&&(f.disabled=!1),H("Не найдено отзывов на странице. Попробуйте прокрутить страницу или перейти на страницу с отзывами.");return}const G=[];let X="";for(let T=0;T<B.length;T++){const O=B[T]||"";if(O)if(X.length===0)if(O.length<=v)X=O,G.push(O);else{const C=O.slice(0,v-1)+"…";X=C,G.push(C);break}else if(X.length+M.length+O.length<=v)X=X+M+O,G.push(O);else break}const W=xe();w&&(w.innerHTML=we(D.avgRating)),i&&(i.innerText=W.totalRatings!=null?W.totalRatings:"—");const I=G,Z={url:location.href,title:document.title,totalRatings:W.totalRatings,avgRating:W.avgRating};console.log("ShopSage: Sending analysis request",{reviewCount:I.length,product:Z,serverUrl:N.serverUrl||"default"}),chrome.runtime.sendMessage({action:Le,reviews:I,product:Z,serverUrl:N.serverUrl||""},T=>{if(chrome.runtime.lastError){console.error("Verdict: runtime.lastError",chrome.runtime.lastError),b&&V(b),f&&(f.disabled=!1),H("Ошибка связи с расширением. Перезагрузите страницу и попробуйте снова.");return}if(b&&V(b),f&&(f.disabled=!1),!T){console.error("Verdict: Empty response from background"),H("Не получен ответ от сервера. Проверьте настройки или попробуйте позже.");return}if(!T.ok){console.error("Verdict: Analysis failed",T);let C="Ошибка анализа";T.error?C=T.error:T.message&&(C=T.message),C.includes("fetch failed")||C.includes("Failed to fetch")?C="Не удалось подключиться к серверу. Проверьте URL сервера в настройках.":C.includes("timeout")?C="Превышено время ожидания ответа от сервера.":C.includes("404")?C="Сервер не найден. Проверьте URL в настройках.":(C.includes("500")||C.includes("502")||C.includes("503"))&&(C="Ошибка сервера. Попробуйте позже."),H(C);return}const O=T.data||{};console.info("Verdict: Analysis successful",T),de(O,Z,I.length)})})}function de(l,v={},M=0){o&&V(o);const N=Array.isArray(l.pros)?l.pros:[],P=Array.isArray(l.cons)?l.cons:[];L&&(L.innerHTML="",N.forEach((E,$)=>{const z=document.createElement("li");z.innerHTML='<div class="tag">'+($+1)+'</div><div class="snippet"></div>',z.querySelector(".snippet").innerText=E,L.appendChild(z)})),A&&(A.innerHTML="",P.forEach((E,$)=>{const z=document.createElement("li");z.innerHTML='<div class="tag">'+($+1)+'</div><div class="snippet"></div>',z.querySelector(".snippet").innerText=E,A.appendChild(z)}));let j=document.querySelector('[data-auto="rating"]');j&&(v.avgRating=parseFloat(j.textContent.trim().replace(",","."))),R&&(R.innerText=l.verdict||"Нет явного вердикта");let B=v&&v.avgRating!=null?Number(v.avgRating):v&&v.rating!=null?Number(v.rating):null,U=v&&v.totalRatings!=null?Number(v.totalRatings):v&&v.totalReviews!=null?Number(v.totalReviews):null;try{if(typeof ae=="function"){const E=ae();E&&(B==null&&E.avg!=null&&(B=E.avg),U==null&&E.totalRatings!=null&&(U=E.totalRatings))}}catch{}const G=typeof ae=="function"?ae():null,X=U||v&&(v.totalReviews||0)||0,W=B??(v&&(v.avgRating||v.rating)?v.avgRating||v.rating:null);let I=Math.max(0,Number(X||0)),Z=0,T=null,O=null,C=null;if(G){const E={};let $=!1;for(let z=1;z<=5;z++){const J=G[String(z)];J!=null&&Number.isFinite(Number(J))&&Number(J)>0?(E[z]=Number(J),$=!0):E[z]=0}$&&(C=E),B==null&&G.avg!=null&&(B=G.avg),U==null&&G.totalRatings!=null&&(U=G.totalRatings)}if(C)Z=Number(C[5]||0)+Number(C[4]||0),I=Object.keys(C).reduce((E,$)=>E+Number(C[$]||0),0),O=I>0?Z/I:null,T=B!=null?B/5:O??.5;else if(I>0&&W!=null){const E=Math.max(0,Math.min(1,(W-1)/4));Z=Math.round(E*I),O=I>0?Z/I:null,T=W/5}else{const E=Array.isArray(l.pros)?l.pros.length:0,$=Array.isArray(l.cons)?l.cons.length:0;if(E+$>0){const z=E/(E+$);I=Math.max(I,E+$),Z=Math.round(z*I),O=z,T=z}else{I=Math.max(I,M||0);const z=.5;Z=Math.round(z*I),O=z,T=T??z}}const Re=2,Ae=2,me=Re+Z,Ee=Ae+(I-Z),re=me/(me+Ee);function ze(E,$,z=1.96){if($===0)return{low:0,high:1};const J=E/$,pe=z*z,fe=1+pe/$,be=J+pe/(2*$),ve=z*Math.sqrt((J*(1-J)+pe/(4*$))/$),qe=Math.max(0,(be-ve)/fe),Ce=Math.min(1,(be+ve)/fe);return{low:qe,high:Ce}}const ue=ze(Z,Math.max(1,I));T==null&&(T=re);const Q=Math.round((re*.6+T*.4)*100);let ee="",ne="";if(Q>=85?(ee="Однозначно стоит выбрать",ne="linear-gradient(90deg,#a3e635,#10b981)"):Q>=70?(ee="В целом рекомендуем",ne="linear-gradient(90deg,#facc15,#84cc16)"):Q>=55?(ee="Стоит взвесить плюсы и минусы",ne="linear-gradient(90deg,#f59e0b,#f97316)"):(ee="Лучше поискать альтернативу",ne="linear-gradient(90deg,#ef4444,#ea580c)"),u&&p(u),h&&(h.innerText=Q+"%",h.style.background=ne),s&&(s.style.width=Q+"%"),c){p(c);const E=Math.round(ue.low*100),$=Math.round(ue.high*100),z=I>0?I:M||"—",J=B!=null?`${B}`:"—";c.innerText=`${ee} — вероятность успеха ≈ ${Math.round(re*100)}% (интервал ${E}–${$}%), на основе ${z} оценок; положительных (4–5★): ${Z}. Средний рейтинг: ${J}★.`}q&&(M!=null&&M!==0?q.innerText=`${M} из ${U??"—"}`:q.innerText=U??"—"),S&&(p(S),setTimeout(()=>S.classList.add("show"),30)),console.info("ShopSage: stats",{n:I,k:Z,estPosRate:O,posteriorMean:re,wilson:ue,composite:Q,rec:ee,pageAvg:B,pageTotalRatings:U,prosCount:N.length,consCount:P.length})}e._shadow=a,e._container=x;function V(l){l.classList.remove("visible"),l.classList.add("hidden")}function p(l){requestAnimationFrame(()=>{l.classList.remove("hidden"),l.classList.add("visible")})}}function le(){const e=document.getElementById(te);e&&(e.style.opacity="0",e.style.transform="translateY(8px) scale(.995)",setTimeout(()=>{try{const a=document.getElementById(te);a&&a.remove()}catch{}},300))}function Ze(e,a,t){try{const r=e.config||{};if(chrome&&chrome.storage&&chrome.storage.sync)return chrome.storage.sync.set({serverUrl:r.serverUrl||"",maxReviews:r.maxReviews!=null?r.maxReviews:void 0},()=>{try{if(typeof K=="function"){try{K(),t&&t({ok:!0,message:"openSidebar() called"})}catch(n){console.warn("openSidebar call failed",n),t&&t({ok:!1,error:String(n)})}return}if(typeof window.openSidebar=="function")try{window.openSidebar(),t&&t({ok:!0,message:"window.openSidebar() called"});return}catch{}if(typeof window.createSidebar=="function")try{window.createSidebar(),t&&t({ok:!0,message:"window.createSidebar() called"});return}catch{}const d=document.getElementById(ge)||document.getElementById("shopsage-open-btn")||document.getElementById("shopsage-open-btn-v2")||document.getElementById("shopsage-open-btn-v3");if(d)try{d.click(),t&&t({ok:!0,message:"button clicked"});return}catch(n){t&&t({ok:!1,message:"failed to click button",error:String(n)});return}t&&t({ok:!1,message:"no sidebar open API found"})}catch(d){console.error("handleOpenSidebarMessage inner error",d),t&&t({ok:!1,error:String(d)})}}),!0;try{typeof K=="function"?(K(),t&&t({ok:!0,message:"openSidebar() called (no storage)"})):t&&t({ok:!1,message:"storage unavailable and openSidebar missing"})}catch(d){t&&t({ok:!1,error:String(d)})}}catch(r){console.error("handleOpenSidebarMessage error",r);try{t&&t({ok:!1,error:String(r)})}catch{}}return!1}function Pe(e,a,t){try{if(!e||!e.action)return;if(e.action==="OPEN_SIDEBAR")return Ze(e,a,t)}catch(r){console.error("handleRuntimeMessage error",r);try{t&&t({ok:!1,error:String(r)})}catch{}}return!1}try{chrome&&chrome.runtime&&chrome.runtime.onMessage&&chrome.runtime.onMessage.addListener(Pe)}catch{}if(!window.__shopSageInitialized){try{typeof K=="function"&&(window.openSidebar=K),typeof le=="function"&&(window.closeSidebar=le),typeof K=="function"&&(window.createSidebar=K)}catch{}try{Te({ROOT_ID:te,BTN_ID:ge,ICON_PATH:Me,onOpenSidebar:typeof K=="function"?K:()=>{const e=document.getElementById(ge)||document.getElementById("shopsage-open-btn")||document.getElementById("shopsage-open-btn-v2");if(e)try{e.click()}catch{}}})}catch(e){console.error("ShopSage: initContent failed",e)}window.__shopSageInitialized=!0}export{le as closeSidebar,K as openSidebar};
